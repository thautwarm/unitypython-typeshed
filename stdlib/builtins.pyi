...
@final
class bytes(Comparable, Sequence[bytes]):
    pass
    @overload
    ...
    def index(self, __sub: bytes | bytearray | int, __start: int = ..., __end: int = ...) -> int: ...
    def isalnum(self) -> bool: ...
    def isalpha(self) -> bool: ...
    def isascii(self) -> bool: ...
    def isdigit(self) -> bool: ...
...
class bytearray(Comparable, Sequence[int]):
    ...
    def count(self, __sub: bytes | bytearray | int, __start: int = 0, __end: int = ...) -> int: ...
    def append(self, __item: int) -> None: ...
    def extend(self, __iterable_of_ints: bytes | bytearray | Iterable[int]) -> None: ...
    def index(
        self, __sub: bytes | bytearray | int, __start: int = 0, __end: int = ..., *, noriase = False
    ) -> int: ...
    ...
    def hex(self, sep: str | bytes = ..., bytes_per_sep: int = ...) -> str: ...
    def endswith(self, __suffix: bytes | bytearray | tuple[bytes, ...], __start: int = 0, __end: int = ...) -> bool: ...
    def isalnum(self) -> bool: ...
    def isalpha(self) -> bool: ...
    def isascii(self) -> bool: ...
    def isspace(self) -> bool: ...
    ...
    def partition(self, __sep: bytes | bytearray) -> tuple[bytearray, bytearray, bytearray]: ...
    def removeprefix(self, __prefix: bytes | bytearray) -> bytearray: ...
    def removesuffix(self, __suffix: bytes | bytearray) -> bytearray: ...
    def replace(self, __old: bytes | bytearray, __new: bytes | bytearray, __count: int = ...) -> bytearray: ...
    ...
    def rpartition(self, __sep: bytes | bytearray) -> tuple[bytearray, bytearray, bytearray]: ...
    def rsplit(self, sep: bytes | bytearray = ..., maxsplit: int = -1) -> list[bytearray]: ...
    def rstrip(self, __bytes: bytes | bytearray = ...) -> bytearray: ...
    def split(self, sep: bytes | bytearray = ..., maxsplit: int = -1) -> list[bytearray]: ...
    def splitlines(self, keepends: bool = False) -> list[bytearray]: ...
    def startswith(self, __prefix: bytes | bytearray | tuple[bytes | bytearray, ...], __start: int  = 0, __end: int = ...) -> bool: ...
    def strip(self, __bytes: bytes = ...) -> bytearray: ...
    def swapcase(self) -> bytearray: ...
    def title(self) -> bytearray: ...
    def translate(self, __table: bytes, delete: bytes | bytearray = ...) -> bytearray: ...
    ...
    @overload
    def __setitem__(self, __s: slice, __x: Iterable[int] | bytes | bytearray) -> None: ...
...
class dict(Collection[_KT], Generic[_KT, _VT]):
    ...
    def values(self) -> iter[_VT]: ...
    def items(self) -> iter[tuple[_KT, _VT]]: ...
...
@overload
def range(__start: int, __stop: int, __step: int = 1) -> iter[int]: ...
@overload
def range(__stop: int) -> iter[int]: ...
...
@overload
def filter(__function: Callable[[_T], Any], __iterable: Iterable[_T]) -> iter[_T]: ...
...
class iter(Generic[_T], Iterator[_T]):
    @overload
    def __new__(
        cls,
        __arg: Iterable[_T],
    ...
    def __next__(self, __refval: ref[Any]) -> TypeGuard[ref[_T]]: ...
...
@overload
def map(func: Callable[[_T1], _S], __iter1: Iterable[_T1]) -> iter[_S]: ...
@overload
def map(
...
@overload
def reversed(__sequence: SupportsLenAndGetItem[_T]) -> iter[_T]: ...
@overload
def reversed(__sequence: Reversible[_T]) -> iter[_T]: ...
...
@overload
def zip(__iterable: Iterable[_T]) -> iter[tuple[_T]]: ...
@overload
def zip(
