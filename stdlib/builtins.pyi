...
class bytes(Comparable, Sequence[int]):
    ...
    def decode(self, encoding: str = ...) -> str: ...  #, errors: str = ...) -> str: ...
...
class dict(Mapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    def update(self, __m: Mapping[_KT, _VT] | list[tuple[_KT, _VT]]) -> None: ...
...
#     def __ixor__(self: Self, __s: AbstractSet[_T]) -> Self: ...  # type: ignore[override,misc]
    def __le__(self, __s: set[object]) -> bool: ...
    def __lt__(self, __s: set[object]) -> bool: ...
    def __ge__(self, __s: set[object]) -> bool: ...
    def __gt__(self, __s: set[object]) -> bool: ...
    __hash__: None  # type: ignore[assignment]
