...
class int:
    def __new__(
        cls: type[Self], __x: str | bytes | bytearray
    ) -> Self: ...
    # if sys.version_info >= (3, 8):
...
#     def center(self, __width: SupportsIndex, __fillchar: bytes = ...) -> bytes: ...
    def count(
        self, __sub: bytes | int | bytearray, __start: int | None = ..., __end: int | None = ...
    ) -> int: ...
...
@final
class list(Comparable[list], MutableSequence[_T], Generic[_T]):
    @overload
    def __init__(self) -> None: ...
    @overload
...
@overload
def zip(__iterable1: Iterable[_T1], __iterable2: Iterable[_T2]) -> iter[tuple[_T1, _T2]]: ...

@overload
def zip(__iterable1: Iterable[_T1], __iterable2: Iterable[_T2], __iterable3: Iterable[_T3]) -> iter[tuple[_T1, _T2, _T3]]: ...

@overload
def zip(__iterable1: Iterable[_T1], __iterable2: Iterable[_T2], __iterable3: Iterable[_T3], __iterable4: Iterable[_T4]) -> iter[tuple[_T1, _T2, _T3, _T4]]: ...
