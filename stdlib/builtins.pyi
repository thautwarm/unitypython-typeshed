...
class type:
    ...
    __class_annotations__: tuple[str, ...]
    @overload
    ...
    # if sys.version_info >= (3, 10):
    def __or__(self, __t: Any) -> UnionType: ...
...
class int:
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @overload
    def __new__(cls: type[Self], __x: str) -> Self: ...
    @overload
    def __new__(cls: type[Self], __x: int) -> Self: ...
    @overload
    def __new__(cls: type[Self], __x: float) -> Self: ...
    @overload
    def __new__(cls: type[Self], __x: bool) -> Self: ...
    # if sys.version_info >= (3, 8):
    ...
    @staticmethod
    def from_bytes(
        bytes: bytes,  # TODO buffer object argument
    ...
    def __eq__(self, __x: int | float) -> bool: ...
    def __ne__(self, __x: int | float) -> bool: ...
    def __lt__(self, __x: int | float) -> bool: ...
    def __le__(self, __x: int | float) -> bool: ...
    def __gt__(self, __x: int | float) -> bool: ...
    def __ge__(self, __x: int | float) -> bool: ...
...
class str(Sequence[str]):
    ...
    def count(self, x: str, __start: int = ..., __end: int = ...) -> int: ...
    def encode(self, encoding: str = ..., errors: str = ...) -> bytes: ...
    def endswith(self, __suffix: str | tuple[str, ...], __start: int = ..., __end: int = ...) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> str: ...
    def find(self, __sub: str, __start: int = ..., __end: int = ...) -> int: ...
    def format(self, *args: object, **kwargs: object) -> str: ...
    def format_map(self, map: Mapping[str, Any]) -> str: ...
    def index(self, __sub: str, __start: int = ..., __end: int = ..., *, noraise: bool = False) -> int: ...
    ...
    def rfind(self, __sub: str, __start: int = ..., __end: int = ...) -> int: ...
    def rindex(self, __sub: str, __start: int = ..., __end:  int = ...) -> int: ...
    ...
    def startswith(self, __prefix: str | tuple[str, ...], __start: int = ..., __end: int = ...) -> bool: ...
...
@final
class bytes(Comparable, Sequence[int]):
    @overload
    def __new__(cls: type[Self], __ints: Iterable[int]) -> Self: ...
    @overload
    def __new__(
        cls: type[Self],
        __string: str,
    ...
    @overload
    def __new__(cls: type[Self], __length: bytes | bytearray) -> Self: ...
    @overload
    def __new__(cls: type[Self]) -> Self: ...
    #     @overload
    ...
    def center(self, __width: int, __fillchar: bytes | bytearray = ...) -> bytes: ...
    def count(
        self,
        __sub: bytes | int | bytearray,
        __start: int = ...,
        __end: int = ...,
    ) -> int: ...
    def index(self, __sub: bytes | bytearray | int, __start: int = ..., __end: int = ..., *, noraise: bool = False) -> int: ...
    def decode(self, encoding: str = 'utf-8') -> str: ...  #, errors: str = ...) -> str: ...
    def expandtabs(self, tabsize: int = ...) -> bytes: ...
    def hex(self, sep: str | bytes = ..., bytes_per_sep: int = ...) -> str: ...
    def endswith(self, __suffix: bytes | bytearray | tuple[bytes | bytearray, ...], __start: int = ..., __end: int = ...) -> bool: ...
    def find(self, __sub: bytes | bytearray, __start: int = ..., __end: int = ...) -> int: ...
    def isalnum(self) -> bool: ...
    def isalpha(self) -> bool: ...
    def isascii(self) -> bool: ...
    def isdigit(self) -> bool: ...
    ...
    def istitle(self) -> bool: ...
    def isupper(self) -> bool: ...
    def join(self, __iterable_of_bytes: Iterable[bytearray | bytes]) -> bytes: ...
    def ljust(self, __width: int, __fillchar: bytes | bytearray = ...) -> bytes: ...
    def lower(self) -> bytes: ...
    def lstrip(self, __bytes: bytes | bytearray = ...) -> bytes: ...
    def partition(self, __sep: bytes | bytearray) -> tuple[bytes, bytes, bytes]: ...
    def replace(self, __old: bytes | bytearray, __new: bytes | bytearray, __count: int = ...) -> bytes: ...
    def removeprefix(self, __prefix: bytes | bytearray) -> bytes: ...
    def removesuffix(self, __suffix: bytes | bytearray) -> bytes: ...

    def rfind(self, __sub: bytes | bytearray, __start: int = ..., __end: int = ...) -> int: ...
    def rindex(self, __sub: bytes | bytearray, __start: int = ..., __end: int = ...) -> int: ...
    def rjust(self, __width: int, __fillchar: bytes | bytearray = ...) -> bytes: ...
    def rpartition(self, __sep: bytes | bytearray) -> tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: bytes | bytearray = ..., maxsplit: int = ...) -> list[bytes]: ...
    def rstrip(self, __bytes: bytes | bytearray = ...) -> bytes: ...
    def split(self, sep: bytes | bytearray = ..., maxsplit: int = ...) -> list[bytes]: ...
    def splitlines(self, keepends: bool = ...) -> list[bytes]: ...
    def startswith(self, __prefix: bytes | bytearray | tuple[bytes | bytearray, ...], __start: int = ..., __end: int = ...) -> bool: ...
    def strip(self, __bytes: bytes | bytearray = ...) -> bytes: ...
    def swapcase(self) -> bytes: ...
    def title(self) -> bytes: ...
    def translate(self, __table: bytes, delete: bytes | bytearray = ...) -> bytes: ...
    ...
    def __mul__(self, __n: int) -> bytes: ...
#     def __rmul__(self, __n: SupportsIndex) -> bytes: ...
#     def __mod__(self, __value: Any) -> bytes: ...
#     # Incompatible with Sequence.__contains__
    def __contains__(self, __o: int | bytes) -> bool: ...  # type: ignore[override]
    def __eq__(self, __x: bytes | bytearray) -> bool: ...
    def __ne__(self, __x: bytes | bytearray) -> bool: ...
    def __lt__(self, __x: bytes | bytearray) -> bool: ...
    def __le__(self, __x: bytes | bytearray) -> bool: ...
    def __gt__(self, __x: bytes | bytearray) -> bool: ...
    def __ge__(self, __x: bytes | bytearray) -> bool: ...

@final
class bytearray(Comparable, Sequence[int]):
    # @overload
    # def __new__(cls: type[Self], __ints: Iterable[int]) -> Self: ...
    # @overload
    # def __new__(
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __buffer: bytes | bytearray) -> None: ...
    @overload
    def __init__(self, __ints: Iterable[int]) -> None: ...
    @overload
    def __init__(self, __string: str, encoding: str) -> None: ...
    @overload
    def __init__(self, __length: int) -> None: ...
    def count(
        self, __sub: bytes | bytearray | int, __start: int = 0, __end: int = ...
    ) -> int: ...
    def append(self, __item: int) -> None: ...
    def extend(self, __iterable_of_ints: bytes | bytearray | Iterable[int]) -> None: ...
    def index(
        self,
        __sub: bytes | bytearray | int,
        __start: int = 0,
        __end: int = ...,
        *,
        noriase=False,
    ...
    def find(self, __sub: bytes, __start: int = 0, __end: int = ...) -> int: ...
    def hex(self, sep: str | bytes = ..., bytes_per_sep: int = ...) -> str: ...
    def endswith(
        self,
        __suffix: bytes | bytearray | tuple[bytes, ...],
        __start: int = 0,
        __end: int = ...,
    ) -> bool: ...
    def isalnum(self) -> bool: ...
    ...
    def lstrip(self, __bytes: bytes | bytearray = ...) -> bytearray: ...
    def ljust(self, __width: int, __fillchar: bytes | bytearray = ...) -> bytearray: ...
    def partition(
        self, __sep: bytes | bytearray
    ) -> tuple[bytearray, bytearray, bytearray]: ...
    def removeprefix(self, __prefix: bytes | bytearray) -> bytearray: ...
    def removesuffix(self, __suffix: bytes | bytearray) -> bytearray: ...
    def replace(
        self, __old: bytes | bytearray, __new: bytes | bytearray, __count: int = ...
    ) -> bytearray: ...
    def rfind(self, __sub: bytes, __start: int = 0, __end: int = ...) -> int: ...
    def rindex(self, __sub: bytes, __start: int = 0, __end: int = ...) -> int: ...
    def rjust(self, __width: int, __fillchar: bytes | bytearray = ...) -> bytearray: ...
    def rpartition(
        self, __sep: bytes | bytearray
    ) -> tuple[bytearray, bytearray, bytearray]: ...
    def rsplit(
        self, sep: bytes | bytearray = ..., maxsplit: int = -1
    ) -> list[bytearray]: ...
    def rstrip(self, __bytes: bytes | bytearray = ...) -> bytearray: ...
    def split(
        self, sep: bytes | bytearray = ..., maxsplit: int = -1
    ) -> list[bytearray]: ...
    ...
    def startswith(
        self,
        __prefix: bytes | bytearray | tuple[bytes | bytearray, ...],
        __start: int = 0,
        __end: int = ...,
    ) -> bool: ...
    def strip(self, __bytes: bytes = ...) -> bytearray: ...
    def swapcase(self) -> bytearray: ...
    def title(self) -> bytearray: ...
    def translate(
        self, __table: bytes, delete: bytes | bytearray = ...
    ) -> bytearray: ...
...
class tuple(Comparable[tuple], Sequence[_T_co], Generic[_T_co]):
    ...
    def __mul__(self, __n: int) -> tuple[_T_co, ...]: ...
    #     def __rmul__(self, __n: SupportsIndex) -> tuple[_T_co, ...]: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    def count(self: tuple[_T], __value: _T) -> int: ...
    def index(self: tuple[_T], __value: _T, __start: int = ..., __stop: int = ..., *, noraise: bool = False) -> int: ...
...
@final
class list(Comparable[list], Sequence[_T], Generic[_T]):
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def index(
        ...
        *,
        ...
        """Indexing a list returns an integer, which is the index of the first item whose value is equal to the argument.
        If 'noraise == True' is passed, the function returns -1 if the value is not found;
        otherwise, a ValueError is raised.
        """
        ...
    def count(self, __value: _T, __start: int = 0, __stop: int = ...) -> int: ...
    ...
    def __eq__(self, __x: list[_T]) -> bool: ...
    def __ne__(self, __x: list[_T]) -> bool: ...
...
class dict(Mapping[_KT, _VT], Generic[_KT, _VT]):
    @overload
    def __new__(cls) -> dict[Any, Any]: ...
    @overload
    def __new__(cls, **kwargs: _VT) -> dict[str, _VT]: ...
    @overload
    def __new__(cls, __map: Mapping[_KT, _VT]) -> dict[_KT, _VT]: ...
    @overload
    def __new__(cls, __map: Mapping[_KT, _VT], **kwargs: _S) -> dict[_KT | str, _VT | _S]: ...    
    @overload
    def __new__(cls, __map: Iterable[tuple[_KT, _VT]]) -> dict[_KT, _VT]: ...
    @overload
    def __new__(cls, __map: Iterable[tuple[_KT, _VT]], **kwargs: _S) -> dict[_KT | str, _VT | _S]: ...    
    @overload
    ...
    def __finditem__(self, __k: _KT, __v_ref: ref[Any]) -> TypeGuard[ref[_VT]]: ...
    __hash__: None  # type: ignore[assignment]
    def __iter__(self) -> Iterator[_KT]: ...
    def __len__(self) -> int: ...
    def __setitem__(self, __k: _KT, v: _VT) -> None: ...
    def __eq__(self, __o: dict[_KT, _VT]) -> bool: ...
    def __ne__(self, __o: dict[_KT, _VT]) -> bool: ...
    def __or__(self, __o: dict[_S, _T]) -> dict[_KT | _S, _VT | _T]: ...
    def __repr__(self) -> str: ...
    ...
    def setdefault(self, __key: _KT, __default: _VT | _T = ...) -> _VT | _T: ...
    @overload
    def update(self, __m: Mapping[_KT, _VT]) -> None: ...
    @overload
    def update(self, __m: Iterable[tuple[_KT, _VT]]) -> None: ...

@final
class set(Collection[_T], Generic[_T]):
    def __init__(self, __iterable: Iterable[_T] = ...) -> None: ...
    ...
    def __contains__(self, __o: object) -> bool: ...
    def __iter__(self) -> Iterator[_T]: ...
    def __add__(self, s: set[_S]) -> set[_T | _S]: ...
    def __sub__(self, s: set[Any]) -> set[_T]: ...
#     def __iand__(self: Self, __s: AbstractSet[object]) -> Self: ...
    def __or__(self, __s: set[_S]) -> set[_T | _S]: ...
...
#     def __isub__(self: Self, __s: AbstractSet[object]) -> Self: ...
    def __xor__(self, __s: set[_S]) -> set[_T | _S]: ...
#     def __ixor__(self: Self, __s: AbstractSet[_T]) -> Self: ...  # type: ignore[override,misc]
    def __le__(self, __s: set[_T | Any]) -> bool: ...
    def __lt__(self, __s: set[_T | Any]) -> bool: ...
    def __ge__(self, __s: set[_T | Any]) -> bool: ...
    def __gt__(self, __s: set[_T | Any]) -> bool: ...
    def __eq__(self, __s: set[_T | Any]) -> bool: ...
    def __ne__(self, __s: set[_T | Any]) -> bool: ...
    __hash__: None  # type: ignore[assignment]
#     if sys.version_info >= (3, 9):
#         def __class_getitem__(cls, __item: Any) -> GenericAlias: ...

# class frozenset(Collection[_T_co], Generic[_T_co]):
#     pass
...
def enumerate(__iterable: Iterable[_T]) -> Iterator[tuple[int, _T]]: ...
...
@overload
def range(__start: int, __stop: int, __step: int = 1) -> Iterator[int]: ...
@overload
def range(__stop: int) -> Iterator[int]: ...
...
# if sys.version_info >= (3, 10):
#     def aiter(__async_iterable: _SupportsAIterator[_SupportsAnextT]) -> _SupportsAnextT: ...
#     @overload
...
@overload
def filter(
    __function: Callable[[_S], TypeGuard[_T]], __iterable: Iterable[_S]
) -> Iterator[_T]: ...
@overload
def filter(
...
def hash(__obj: SupportsHash) -> int: ...

# def help(request: object = ...) -> None: ...
def hex(__number: int) -> str: ...

# def id(__obj: object) -> int: ...
# def input(__prompt: object = ...) -> str: ...

class iter(Generic[_T_co], Iterator[_T_co]):
    @overload
    def __new__(
        cls,
        __arg: Iterable[_T_co],
    ) -> iter[_T_co]: ...
    @overload
    def __new__(
        cls,
        __gen: Generator[_T, _T1, _T2],
    ) -> Generator[_T, _T1, _T2]: ...
...
@overload
def map(func: Callable[[_T1], _S], __iter1: Iterable[_T1]) -> Iterator[_S]: ...
@overload
def map(
...
def print(
    *values: object,
    ...
    """Unity Python specific 'print' function.

    In Unity Environment, it calls 'Debug.Log';

    Otherwise, it calls 'Console.WriteLine'.
    """
    ...
...
@overload
def pow(base: int, exp: int) -> int | float: ...
@overload
def pow(base: int, exp: _PositiveInteger) -> int: ...
@overload
def pow(base: int, exp: _NegativeInteger) -> float: ...
@overload
def pow(base: int, exp: float) -> float: ...
@overload
def pow(base: float, exp: int | float) -> float: ...
@overload
...
@overload
def reversed(__sequence: SupportsLenAndGetItem[_T]) -> Iterator[_T]: ...
@overload
...
# else:
class SupportAdd(Protocol[_T]):
    def __add__(self, __other: _T) -> _T: ...

SupportAddT = TypeVar("SupportAddT", bound=SupportAdd)  # noqa: Y001

@overload
def sum(__iterable: Iterable[SupportAddT]) -> SupportAddT: ...
@overload
def sum(__iterable: Iterable[SupportAddT], start: SupportAddT) -> SupportAddT: ...
...
@overload
def zip(__iterable: Iterable[_T]) -> Iterator[tuple[_T]]: ...
@overload
def zip(
    __iterable1: Iterable[_T1], __iterable2: Iterable[_T2]
) -> Iterator[tuple[_T1, _T2]]: ...
@overload
def zip(
    __iterable1: Iterable[_T1], __iterable2: Iterable[_T2], __iterable3: Iterable[_T3]
...
@overload
def zip(*__iterable1: Iterable[Any]) -> tuple: ...
