...
@runtime_checkable
class SupportNext(Protocol[_T]):
    @abstractmethod
    def __trynext__(self, __refval: ref[Any]) -> TypeGuard[ref[_T]]: ...
...
@runtime_checkable
class Iterator(SupportNext[_T_co], Iterable[_T_co]):
    def map(self, __function: Callable[[_T_co], _G]) -> Iterator[_G]: ...
    def mapi(self, __function: Callable[[int, _T_co], _G]) -> Iterator[_G]: ...
    @overload
    def filter(self, __function: Callable[[_T_co], bool]) -> Iterator[_T_co]: ...
    @overload
    def filter(self, __function: Callable[[_T_co], TypeGuard[_S]]) -> Iterator[_S]: ...
    @overload
    def filteri(self, __function: Callable[[int, _T_co], bool]) -> Iterator[_T_co]: ...
    @overload
    def filteri(self, __function: Callable[[int, _T_co], TypeGuard[_S]]) -> Iterator[_S]: ...
    def skip(self, __i: int) -> Iterator[_T_co]: ...
    def foreach(self, __action:Callable[[_T_co], Any]) -> None: ...
    def foreachi(self, __action:Callable[[int, _T_co], Any]) -> None: ...
    def append(self: Iterator[_T], __x: _T) -> Iterator[_T]: ...
    def prepend(self: Iterator[_T], __x:_T) -> Iterator[_T]: ...
    def concat(self, __iterable: Iterable[_T_co]) -> Iterator[_T_co]: ...
    @overload
    def sum(self: Iterable[int]) -> int: ...
    @overload
    def sum(self: Iterable[float], __init: int = 0) -> float | int: ...
    @overload
    def sum(self: Iterable[_T_number], __init: float = 0) -> float: ...
    def tolist(self) -> list[_T_co]: ...
    # def zip(self, __iterable: Iterable[_S]) -> Iterator[Tuple[_S, _S]]: ...
...
class Generator(Awaitable[_V_co], Iterator[_T_co], Generic[_T_co, _T_contra, _V_co]):
    def __trynext__(self, __refval: ref[Any]) -> TypeGuard[ref[_T_co]]: ...
    @property
...
@runtime_checkable
class Mapping(ABC, Collection[_KT], Generic[_KT, _VT_co]):
    ...
    def items(self) -> Iterator[tuple[_KT, _VT_co]]: ...
    def keys(self) -> Iterator[_KT]: ...
    def values(self) -> Iterator[_VT_co]: ...
